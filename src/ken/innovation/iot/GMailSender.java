...
public class GMailSender extends javax.mail.Authenticator {   
	...
	public synchronized void sendMail(String subject, String body, String recipients, String[] attachFile) throws Exception {   
		try{
			...
			message.setContent(addAttachment(attachFile));
	...
	public Multipart addAttachment(String[] attachFile) throws Exception {
		Multipart _multipart = new MimeMultipart();
		for(String filename : attachFile){
			...
			messageBodyPart2.setText(filename); 
